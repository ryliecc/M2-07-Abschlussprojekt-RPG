...
class Ronin: Hero {
    let quickSlash: Attack = Attack(name: "Quick Slash", powerMultiplier: 1.1, manaCost: 0, type: .damage, infoText: "A fast and sharp slash aimed at vital spots.")
    let focusedStrike: Attack = Attack(name: "Focused Strike", powerMultiplier: 1.7, manaCost: 5, type: .damage, infoText: "A precise, deliberate blow with deadly intent.")
    let innerCalm: Attack = Attack(name: "Inner Calm", powerMultiplier: 0.9, manaCost: 3, type: .buffDefense, infoText: "Focuses breath and stance to increase defense.")
