...
class Sorcerer: Hero {
    ...
    let chaosBolt: Attack = Attack(name: "Chaos Bolt", powerMultiplier: 1.3, manaCost: 5, type: .damage, infoText: "A violent arcane blast that explodes on impact.", isSelfTargeting: false)
    let arcaneHeal: Attack = Attack(name: "Arcane Heal", powerMultiplier: 1.0, manaCost: 5, type: .heal, infoText: "A soothing spell that mends the wounds of allies, restoring health.", isSelfTargeting: false)
