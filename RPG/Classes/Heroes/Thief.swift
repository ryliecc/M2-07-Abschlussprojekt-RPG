...
class Thief: Hero {
    ...
    let spikeTrap: Attack = Attack(name: "Spike Trap", powerMultiplier: 1.0, manaCost: 2, type: .trap, infoText: "Sets a trap that springs on the next enemy to cross it, dealing significant damage.", isSelfTargeting: true)
    let smokeBomb: Attack = Attack(name: "Smoke Bomb", powerMultiplier: 0.7, manaCost: 1, type: .debuffAttack, infoText: "Throws a smoke bomb that disorients the enemy, reducing their attack accuracy.", isSelfTargeting: false)
