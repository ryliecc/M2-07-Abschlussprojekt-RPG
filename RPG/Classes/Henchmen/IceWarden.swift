...
class IceWarden: Henchman {
    ...
    let frostAura: Attack = Attack(name: "Frost Aura", powerMultiplier: 1.2, manaCost: 3, type: .buffDefense, infoText: "The Ice Warden emanates a cold aura, boosting his defense.", isSelfTargeting: true)
