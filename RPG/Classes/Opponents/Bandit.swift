...
class Bandit: Opponent {
    ...
    init(level: Int) {
        super.init(name: "Bandit", maxHealthPoints: 20, maxManaPoints: 5, attacks: [slash, dirtyTrick], attackPower: 7, defense: 5, tempo: 1, level: level, healthMultiplier: 2, manaMultiplier: 3, attackMultiplier: 3, defenseMultiplier: 2, tempoMultiplier: 1)
    }
}
