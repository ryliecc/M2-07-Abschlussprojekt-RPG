...
class GoblinScout: Opponent {
    ...
    init(level: Int) {
        super.init(name: "Goblin Scout", maxHealthPoints: 15, maxManaPoints: 5, attacks: [stab, dodge], attackPower: 5, defense: 3, level: level, healthMultiplier: 2, manaMultiplier: 3, attackMultiplier: 3, defenseMultiplier: 2)
    }
}
