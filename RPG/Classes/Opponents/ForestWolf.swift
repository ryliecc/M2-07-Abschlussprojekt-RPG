...
class ForestWolf: Opponent {
    ...
    init(level: Int) {
        super.init(name: "Forest Wolf", maxHealthPoints: 18, maxManaPoints: 4, attacks: [bite, howl], attackPower: 6, defense: 4, level: level, healthMultiplier: 2, manaMultiplier: 3, attackMultiplier: 3, defenseMultiplier: 2)
    }
}
