...
class StormDragon: Boss {
    ...
    let lightningShield: Attack = Attack(name: "Lightning Shield", powerMultiplier: 0.4, manaCost: 0, type: .buffDefense, infoText: "The Dragon surrounds itself with a shield of crackling lightning, boosting its defense.", isSelfTargeting: true)
