...
class DarkKnight: Boss {
    ...
    let reapersWrath: Attack = Attack(name: "Reaper's Wrath", powerMultiplier: 2.5, manaCost: 10, type: .ultimate, infoText: "The Dark Knight channels the essence of death, delivering a massive blow that devastates the enemy.", isSelfTargeting: false)
